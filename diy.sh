...
svn_export "main" "luci-app-daed-next" "package/luci-app-daed-next" "https://github.com/sbwml/luci-app-daed-next"
svn_export "main" "daed-next" "package/daed-next" "https://github.com/sbwml/luci-app-daed-next"
